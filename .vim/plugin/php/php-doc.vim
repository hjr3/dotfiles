...
" Version 1.0.2
" -------------
"  * Fixed regex for class declaration
"  * ATTENTION: This version already has code for the next version 1.1.0,
"  which is propably not working!
"
" Version 1.0.3
" -------------
"  * Gloabl configs can now be setup in a seperate .vim plugin or .vimrc file.
"  * ATTENTION: This version already has code for the next version 1.1.0,
"  which is propably not working!
"
...
if !exists("g:pdv_cfg_Author")
    let g:pdv_cfg_Author = "Unknown user"
endif
if !exists("g:pdv_cfg_Copyright")
    let g:pdv_cfg_Copyright = "1997-2009 The PHP Group"
endif
